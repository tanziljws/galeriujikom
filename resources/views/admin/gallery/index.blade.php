...
<<<<<<< HEAD
                        <div class="d-flex align-items-center gap-2">
                            <span class="badge bg-secondary-subtle text-secondary">{{ $item['photo_count'] ?? 0 }} foto</span>
                    ...
                    <div class="d-flex gap-2 mt-2 flex-nowrap">
                        <a href="{{ route('admin.gallery.album.manage', $item['title']) }}" class="btn btn-sm btn-outline-primary w-100"><i class="ri-tools-line me-1"></i> Kelola Foto</a>
=======
                        <small class="text-muted">{{ isset($item['uploaded_at']) ? \Illuminate\Support\Carbon::parse($item['uploaded_at'])->format('Y-m-d') : '-' }}</small>
                    </div>
                    <div class="d-flex gap-2 mt-2 flex-nowrap">
