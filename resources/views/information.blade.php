        ...
        <div class="container section-soft accented decor-gradient-top">
            ...
            @if($informations->isEmpty())
                <div class="text-center py-5">
                    <div class="mb-4">
                        <i class="fas fa-info-circle" style="font-size: 4rem; color: #7A9CC6;"></i>
                    </div>
                    <h3 class="h5 text-muted mb-2">Belum Ada Informasi</h3>
                    <p class="text-muted">Informasi akan ditampilkan di sini ketika sudah tersedia.</p>
                </div>
            @else
                <div class="row g-4">
